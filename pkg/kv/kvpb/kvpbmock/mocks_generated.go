...
func (m *MockInternalClient) RangeFeed(arg0 context.Context, arg1 *kvpb.RangeFeedRequest, arg2 ...grpc.CallOption) (kvpb.Internal_RangeFeedClient, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
	...
	ret0, _ := ret[0].(kvpb.Internal_RangeFeedClient)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockInternal_RangeFeedClient) Recv() (*kvpb.RangeFeedEvent, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Recv")
	ret0, _ := ret[0].(*kvpb.RangeFeedEvent)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
